lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus autem repellat dolore ullam voluptatibus eum itaque omnis ipsam, laudantium suscipit quae a, aliquid non et expedita nulla deleniti. Dolore repellendus possimus beatae.",
  },
];
...
function PatientDetails() {
    ...
    const fetchPatientData = async () => {
      try {
        const res = await axios.get(
          `https://hms-w4kw.onrender.com/api/Patient/GetPatientById/${id}`
        );
  ...
  return (
    <div className="flex flex-col gap-0 lg:flex-row py-4 md:px-0 ">
      ...
      <div
        className="fixed right-0 top-[50%] p-2 rounded-lg text-[24px] z-20 bg-primary"
          ...
          <div className="lg:w-[33.33%] w-[100%] flex flex-col gap-4 ">
            ...
            <div className="rounded-lg border shadow-lg ">
              ...
              <div className="flex justify-between p-4 ">
                <button className="px-4 py-2 rounded-lg bg-red-300 text-red-600 ">
                  Unassign
                </button>
                <button className="px-4 py-2 rounded-lg bg-green-100 text-green-600 ">
                  Check
                </button>
              </div>
            </div>
          ...
          <div className="w-[100%] lg:w-[66.67%] flex flex-col gap-4 ">
            ...
            <div className="flex flex-wrap gap-2 items-center justify-between">
              <div className="flex items-center gap-2">
                <button
                  className="flex items-center px-4 py-2 bg-primary hover:bg-primaryhover transition-all text-white rounded-lg"
              ...
              <div className="flex items-center gap-2">
                <button
                  className="flex gap-2 items-center px-4 py-2 bg-primary hover:bg-primaryhover transition-all text-white rounded-lg"
                ...
                <div>
                  ...
                  <p className="flex items-center gap-1 ">
                    ...
                    {patientData.length > 0
                      ? formatDate(patientData.registerDate)
                      : "Admin on 15 October 2024, 10:00 AM"}
                  </p>
                </div>
              </div>
      ...
      {openBookVitalsModal && (
        <div className="fixed w-[100%] h-[100%] flex items-center justify-center z-50 bg-[#00000066] ">
          <div className=" flex items-center justify-center w-[50vw] h-[80vh] bg-white p-14 relative">
            <button
              className="bg-primary rounded-xl text-white p-2 text-[30px] shadow-lg absolute right-4 top-4 "
            ...
            <form action="submit">
              ...
              <select
                name=""
                id=""
                className="border mt-4 w-[100%] p-3 rounded-lg "
              >
              ...
              <button className="w-[100%] bg-primary text-white font-medium p-3 rounded-lg mt-4 hover:bg-primaryhover transition-all ">
                Book
              </button>
            </form>
          </div>
        ...
        <div className="fixed w-[100%] h-[100%] flex items-center justify-center z-50 bg-[#00000066] ">
          <div className=" flex items-center justify-center w-[50vw] h-auto bg-white px-14 py-6 relative">
            ...
            <form action="submit" className="space-y-2">
              ...
              <input
                type="text"
                placeholder="Enter patient prescribed medication"
                className="border p-3 rounded-lg w-[100%] "
              />
              <textarea
                type="text"
                placeholder="Enter doctors note"
                className="border p-3 rounded-lg w-[100%] "
              />
              <button className="w-[100%] bg-primary text-white font-medium p-3 rounded-lg mt-4 hover:bg-primaryhover transition-all">
                Create EMR
