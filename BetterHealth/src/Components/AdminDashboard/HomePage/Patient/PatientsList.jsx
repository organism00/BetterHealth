...
function PatientsList() {
  ...
  return (
    <div className="flex gap-0">
      <Sidebar />
      <Navbar />
      <div className='className="w-full lg:w-[78vw] lg:ml-[18vw] z-0 md:pt-20 pb-12 lg:py-8 px-4 lg:px-4'>
          ...
          <div className="flex flex-col items-center ">
            <TableContainer component={Paper} style={{ width: "100%" }}>
              <Table>
                ...
                <TableBody>
                  {patientsListFromApi.length > 0
                    ? patientsListFromApi.map((row) => (
                        <TableRow key={row.$id} className="">
                          ...
                          <TableCell>
                            <div className="text-[12px]">{row.gender}</div>
                          </TableCell>
                          <TableCell>
                            <div className="text-[12px]">
                            ...
                            >
                              ...
                              {id === row.patientId && openEditMenu ? (
                                <div className="shadow-lg px-6 py-4 rounded-lg border absolute right-8 top-4 bg-white text-[14px] text-left grid gap-4 w-[150px] z-50 ">
                                  <p onClick={() => handleView(row.patientId)}>
                                    View
                                  </p>
                                  <p onClick={() => handleEdit(row.patientId)}>
                                    Edit
                                  </p>
                                  <p
            ...
            {currentPatientList ? (
              <div className="bg-[#e4e6ef] text-text px-4 py-4 flex justify-between items-center rounded-b-lg text-[12px] w-[100%] ">
                <p>
                  Showing {currentPage} to {patientPerPage} of {patients.length}{" "}
                  enteries
                </p>
