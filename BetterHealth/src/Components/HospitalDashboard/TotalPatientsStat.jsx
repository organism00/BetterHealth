  ...
  return (
    <div>
      <div className='shadow-lg pb-12 pt-2 rounded-lg border'>
        <p className='mb-4 py-4 px-8 border-b w-[100%] text-[18px] text-[#172b4c] font-medium '>Total Patients</p>
        <ComposedChart width={320} height={250} data={totalPatient} className='w-[100%]'>
