...
const Patientdashboard = () => {
    return (
        ...
        <div className="lg:grid lg:grid-cols-[16rem_1fr] z-0">
            ...
            <div className="lg:hidden flex flex-col md:flex md:flex-col py-8 md:py-20 lg:flex lg:flex-row space-y-4 lg:space-x-4  lg:w-[80vw] lg:h-[100vh]">
                <div className='w-[100%] h-auto bg-yellow-900 md:bg-red-600 lg:w-[55vw] lg:h-[12vh] lg:ml-64'>
                    ...
                    <div className='bg-[whitesmoke] w-[95%] h-[40vh] md:w-[106%] md:h-[35vh] shadow-md rounded-t-xl flex flex-col py-5 space-y-4 border-t-2'>
                    ...
                    {/* secti0n9 a  */}
                    <div className='flex justify-center w-[95%] rounded-b-lg h-[10vh] md:w-[106%]'>
            ...
            <div className="hidden lg:flex lg:flex-row lg:space-x-1 lg:w-[80vw] lg:h-[100vh] lg:mt-20">
                ...
                {/* section2 */}
                <div className='w-[55vw] h-[auto] bg-red-600 ml-64 flex flex-row flex-wrap py-2 px-4 space-x-4'>
                    <div className='w-[11vw] h-[37vh] bg-green-400'>
            ...
            <div className='lg:ml-[-24px] lg:py-4'>
                <HeartRateChart />
                    ...
                    <div className='w-[13vw] h-[33vh] bg-green-400'>
                ...
                <div className='ml-[-24px] py-8'>
                    ...
                    <div className='flex flex-col space-y-4'>
                        <div className='w-[12vw] h-[22vh] bg-green-400'>
                        <div className='lg:w-[12vw] lg:h-[23vh] bg-white rounded-md shadow-md lg:px-4 lg:py-5 lg:space-y-3 lg:border-t-2'>
                ...
                <div className='flex justify-between'>
                    ...
                    <h1 className='lg:font-light text-[15px]'>Lower</h1>
                        ...
                        <div className='w-[12vw] h-[13vh] bg-green-400'>
                        <div className='lg:w-[12vw] lg:h-[13vh] bg-white rounded-md shadow-md lg:space-y-3 lg:py-4 lg:px-4 lg:border-t-2'>
                <div className=' flex justify-between'>
                ...
                <div className='lg:font-light'>
                    ...
                    <div className='flex flex-col space-y-4'>
                        <div className='w-[12vw] h-[26vh] bg-green-400'>
                        <div className='lg:w-[12vw] lg:h-[26vh] rounded-md bg-white shadow-md lg:px-2 lg:py-5 lg:space-y-3 lg:border-t-2' >
                <div>
                ...
                <div className='flex flex-row justify-between'>
                    ...
                    <h1 className='lg:text-[14px]'>Yesterday</h1>
                        ...
                        <div className='w-[12vw] h-[15vh] bg-green-400'>
             ...
             <div className='lg:flex lg:flex-row lg:space-x-1'>
                ...
                <div className='py-3 px-1 lg:flex lg:flex-col lg:pl-4'>
                    ...
                    <div className='w-[27vw] h-[45vh] bg-violet-800 mt-5'>
                    <div className='lg:w-[27vw] lg:h-[45vh] bg-white rounded-md shadow-md lg:border-t-2 py-4'>
        <div className='px-4  text-xl'>
                ...
                <div className='w-[350px] h-[6px] px-5 py-10 '>
                    ...
                    <div className='w-[22vw] h-[45vh] bg-violet-400 mt-5'>
                    <div className='lg:w-[22vw] lg:h-[45vh] bg-white rounded-md shadow-md lg:border-t-2'>
        <div className='flex flex-col py-4 space-y-2 place-items-center '>
                ...
                <div className=' flex flew-row justify-center  '>
                    ...
                    <div className='w-[31vw] h-[45vh] bg-yellow-400 mt-5'>
                    {/* <div className='lg:w-[50vw] lg:h-[50vh] bg-white lg:mt-[-115px] lg:px-5 lg:space-x-5 lg:flex '> */}
        <div className='lg:w-[31vw] lg:h-[44vh] bg-white rounded-md shadow-md lg:py-4 lg:border-t-2'>
        <div className='lg:flex lg:justify-between lg:px-4'>
                ...
                <div className='lg:w-[31vw] lg:h-[8vh] bg-indigo-500 rounded-lg px-7 flex gap-2 text-white text-[14px] py-2'>
                    ...
                    <div className='flex flex-col space-y-3 mt-5'>
                        <div className='w-[18vw] h-[23vh] bg-green-400'>
                        <div className='lg:flex lg:flex-col lg:space-y-5 '>
            <div className='lg:w-[18vw] lg:h-[23vh] bg-white rounded-md shadow-md lg:px-5 lg:py-7 lg:border-t-2'>
              <div className=''>
                ...
                <h1 className='lg:text-2xl lg:font-light'> 85-89</h1>
                        ...
                        <div className='w-[18vw] h-[23vh] bg-green-400'>
                        <div className='lg:w-[18vw] lg:h-[23vh] bg-white rounded-md  shadow-md lg:px-5 lg:py-5 lg:border-t-2'>
            <div>
                ...
                {/* thirdsection */}
                <div className='w-[25vw] h-[154vh] bg-yellow-600 text-wrap px-2 space-y-4 py-7'>
                  <div className='w-[22vw] h-[16vh] bg-blue-400'>
                  <div className='lg:w-[22vw] lg:h-[16vh] bg-white rounded-md shadow-md lg:px-6 lg:py-6 lg:border-t-2 lg:flex lg:space-x-3'>
                <div className='py-1'>
                ...
                <div className='flex flex-col text-blue-600'>
                  ...
                  <div className='w-[22vw] h-[5vh] bg-blue-400'>
         ...
         <h1>Schedule Appointments</h1>
                  ...
                  <div className='w-[22vw] h-[44vh] bg-blue-400'>
                  <div className='lg:w-[22vw] lg:h-[44vh] bg-white rounded-md shadow-md lg:border-t-2 '> 
        <div className='py-5 px-5 gap-3'>
                ...
                <div className='flex justify-end px-3 py-6 '>
                  ...
                  <div className='w-[22vw] h-[39vh] bg-blue-400'>
                  <div className='lg:w-[22vw] lg:h-[39vh] bg-white rounded-md shadow-md lg:border-t-2'>
        <div className='py-5 px-2 gap-3'>
