...
const Staff = () => {
  ...
  return (
    <div className="min-h-screen bg-[whitesmoke] flex overflow-hidden">
      ...
      {/* Right - Form */}
      <div className="w-full lg:w-[50vw] bg-[whitesmoke] md:py-36 lg:px-24 md:px-10 flex flex-col py-6 px-4 overflow-auto mt-12">
        <div className="max-w-md w-full mx-auto">
          <div className=" space-y-6 mb-8">
            ...
            <p className="text-gray-600 leading-4 font-[inter] mt-2">
              Welcome back! Enter your credentials to login as Staff.
            </p>
          </div>
