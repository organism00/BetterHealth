                        ...
                        <section className='flex flex-col lg:flex-row  gap-x-8 gap-y-8'>
                            <section className='w-full lg:w-[69%]  rounded-lg h-auto'>
                                <div className='flex flex-col lg:flex-row gap-x-5 gap-y-8'>
                                    <div className='flex lg:h-72 lg:flex-row md:flex-row flex-col lg:w-[50%] md:w-screen w-full gap-x-7 gap-y-8 px-'>
                                    ...
                                    <div className='lg:w-[50%] h-96 lg:h-72 flex flex-col gap-y-5 lg:place-content-between'>
                                        ...
                                        <div className="scrollable-div h-[240px] md:h-[240px] mt-2 overflow-auto font-light  border border-gray-200 rounded-lg shadow-lg ">
                                            <div className="">
                                                {patientData.map((patient, index) => {
                                                    ...
                                                    <div key={index} className="flex justify-between items-center w-[100%] h-20 px-6">
                                                        ...
                                                        <div className="w-[70%] h-12 px-2 bg-gray-100 flex items-center justify-between rounded-lg">
