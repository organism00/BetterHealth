                  ...
                  <div className="flex gap-5">
                    ...
                    <div className="my-7 w-full border-[1px] border-stone-100 h-[90%] lg:h-[109vh]  shadow-md rounded-2xl ">
                      ...
                      <div className="bg-indigo-500 w-56 mx-4 h-10 rounded-lg pt-1">
                        <h1 className="text-center text-xl text-stone-300">Patient Information</h1>
                      </div>
                        ...
                        <div className="w-full mx-auto mt-5 p-4">
                          <form>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <input type="text" name="text" id="" className="border p-2 w-full" placeholder="contact number"/>
                              <input type="text" name="text" id="" className="border p-2 w-full" placeholder="Emergency number"/>
                              <input type="text" name="text" id="" className="border p-2 w-full" placeholder="Has ulcer"/>
                            ...
                            <div className="flex justify-end mt-5 lg:mt-12 ">
                              <button type="submit" className="w-1/3 justify-self-end col-span-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Save</button>
                            </div>
                          </form>
                        </div>
                    </div>
